...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="main.jsp">나혼자요리</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="main.jsp">메인</a></li>
				<li><a href="../file/FileController?action=list">레시피</a></li>
		...
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					%>
					<tr>
						<td><%= list.get(i).getBssID() %></td>
						<td><a href="view.jsp?bssID=<%= list.get(i).getBssID() %>"><%= list.get(i).getBssTitle() %></a></td>
						<td><%= list.get(i).getUserID() %></td>
						<td><%= list.get(i).getBssDate().substring(0, 11) + list.get(i).getBssDate().substring(11, 13) + "시" + list.get(i).getBssDate().substring(14, 16) + "분" %></td>
					</tr>
					<%
						}
					%>
